...
if (have_posts()) {
    ...
    if ($blog_sections_count) {
        for ($template_idx = 0; $template_idx < $templates_count; $template_idx++) {
            ...
            $blog_dialog_path = get_template_directory() . '/template-parts/'. $blog_custom_template . $translations . '/blog-dialogs.php';
            if (file_exists($blog_dialog_path)) {
                include $blog_dialog_path;
            }
